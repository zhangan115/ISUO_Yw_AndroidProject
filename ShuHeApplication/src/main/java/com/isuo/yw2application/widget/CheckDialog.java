...
import com.isuo.yw2application.utils.commadapter.CommonAdapter;
import com.isuo.yw2application.utils.commadapter.ViewHolder;
...
public class CheckDialog extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mExpendRecycleView.setLayoutManager(new GridLayoutManager(activity, 1));
...
//        RVAdapter<CheckValue.ValueListBean> adapter = new RVAdapter<CheckValue.ValueListBean>(mExpendRecycleView, listBeen, R.layout.item_dialog_check) {
//            @Override
//            public void showData(ViewHolder vHolder, CheckValue.ValueListBean data, int position) {
