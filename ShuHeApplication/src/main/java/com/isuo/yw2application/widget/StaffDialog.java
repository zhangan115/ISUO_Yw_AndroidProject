...
public class StaffDialog extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStaffName = findViewById(R.id.id_staff_name);
        mPlanTime = findViewById(R.id.id_staff_plantime);
        mRepTime = findViewById(R.id.id_staff_reptime);
        mRepPlace = findViewById(R.id.id_staff_repplace);
        mStaffGrpup = findViewById(R.id.id_staff_group);
        mButton = findViewById(R.id.id_staff_ok);
