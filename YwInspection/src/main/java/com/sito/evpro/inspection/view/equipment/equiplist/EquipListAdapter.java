...
import com.sito.evpro.inspection.mode.bean.equip.EquipName;
...
public class EquipListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (data.size() == 1) {
            ...
            holder.mGroup.setBackground(context.getResources().getDrawable(R.drawable.bg));
            if (isExpanded) {
                holder.mGroup.setBackground(context.getResources().getDrawable(R.drawable.bg_centre));
            }
        } else if (groupPosition == 0) {
            holder.mLine.setVisibility(View.VISIBLE);
            holder.mGroup.setBackground(context.getResources().getDrawable(R.drawable.bg_up));
        } else if (groupPosition == data.size() - 1) {
            holder.mLine.setVisibility(View.GONE);
            holder.mGroup.setBackground(context.getResources().getDrawable(R.drawable.bg_down));
            if (isExpanded) {
                holder.mGroup.setBackground(context.getResources().getDrawable(R.drawable.bg_centre));
            }
        } else {
