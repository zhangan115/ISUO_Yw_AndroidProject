...
import com.sito.evpro.inspection.widget.InspectionType1;
import com.sito.evpro.inspection.widget.InspectionType2;
...
class DataAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.tv_equipment_count = (TextView) convertView.findViewById(R.id.tv_equipment_count);
