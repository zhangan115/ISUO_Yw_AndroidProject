package com.sito.evpro.inspection.view.speech.voice;
...
//    public static final String recordPath = "/data/data/com.sito.evpro.inspection/files/";
    public static final String recordPath = InspectionApp.getInstance().voiceCacheFile();
        ...
        try {
            ...
            mMediaPlayer.setOnErrorListener(new MediaPlayer.OnErrorListener() {
                ...
                public boolean onError(MediaPlayer arg0, int arg1, int arg2) {
                    InspectionApp.getInstance().showToast("播放错误");
                    return false;
                }
            });
        } catch (Exception e) {
