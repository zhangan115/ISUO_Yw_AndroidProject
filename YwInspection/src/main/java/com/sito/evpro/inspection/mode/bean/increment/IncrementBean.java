...
public class IncrementBean implements Parcelable {
    ...
    public WorkUser getIssuedUser() {
        return issuedUser;
    }

    public void setIssuedUser(WorkUser issuedUser) {
    ...
    public void setUser(WorkUser user) {
        this.user = user;
    }
    ...
    protected IncrementBean(Parcel in) {
        ...
        this.user = in.readParcelable(WorkUser.class.getClassLoader());
        this.issuedUser = in.readParcelable(WorkUser.class.getClassLoader());
