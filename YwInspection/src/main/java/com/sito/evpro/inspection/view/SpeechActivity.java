...
public class SpeechActivity extends BaseActivity {
    ...
    public void setParam() {
        ...
        if (TextUtils.isEmpty(voiceName)) {
            ...
            if (new File(InspectionApp.getInstance().getCacheDir() + File.separator + voiceName + ".wav").exists()) {
                new File(InspectionApp.getInstance().getCacheDir() + File.separator + voiceName + ".wav").delete();
            }
            mIat.setParameter(SpeechConstant.ASR_AUDIO_PATH, InspectionApp.getInstance().getCacheDir() + File.separator + voiceName + ".wav");
        }
