package com.sito.evpro.inspection.view.setting.test;
...
public class TestActivity extends BaseActivity {
    ...
    //private static final String HOST = "https://www.ewaypro.cn/api";//正式版
    private static final String HOST = "https://114.118.94.117:8080/isuoyw/api";//正式版
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = InspectionApp.getInstance().AppHost();
        String str = "当前请求IP为";
        switch (url) {
            case HOST:
                str = str + "正式版";
        ...
        new MaterialDialog.Builder(this)
                ...
                .itemsCallback(new MaterialDialog.ListCallback() {
                    ...
                    public void onSelection(MaterialDialog dialog, View itemView, int position, CharSequence text) {
                        InspectionApp.getInstance().editHost(hostList.get(position));
                        InspectionApp.getInstance().showToast(getString(R.string.please_waite));
