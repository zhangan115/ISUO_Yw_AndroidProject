...
public class EquipmentDataDb implements Parcelable {
    ...
    private long currentUserId = InspectionApp.getInstance().getCurrentUser().getUserId();
    ...
    @Generated(hash = 46573575)
    public EquipmentDataDb(Long _id, int type, String value, long taskId, long roomId, long equipmentId,
            String chooseInspectionName, long dataItemId, String localPhoto, long currentUserId) {
        this._id = _id;
        this.type = type;
        this.value = value;
        this.taskId = taskId;
