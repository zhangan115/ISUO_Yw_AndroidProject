...
public class CreateEquipmentDb implements Parcelable {
    ...
    @Generated(hash = 1469386701)
    public CreateEquipmentDb(Long _id, Long equipmentId, String equipmentName, int equipmentTypeId, int voltageGradesId,
            String equipmentNum, String productNum, long createTime, boolean needUpload, int userId) {
        this._id = _id;
