...
public class UpdateManager {
    ...
    private void showDownloadDialog() {
        ...
        if (freeDiskSize < 52428800) {//50 * 1024 * 1024
            InspectionApp.getInstance().showToast(mContext.getString(R.string.no_more_free_disk));
        } else {
    ...
    private void installApk() {
        ...
        try {
            ...
            e.printStackTrace();
            InspectionApp.getInstance().showToast("App已经下载完毕,请在下载目录下安装");
        }
    }
}