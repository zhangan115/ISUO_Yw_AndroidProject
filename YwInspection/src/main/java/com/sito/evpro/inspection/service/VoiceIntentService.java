...
public class VoiceIntentService extends IntentService {
    ...
    private static final String ACTION_FOO = "com.sito.evpro.inspection.service.action.FOO";
    private static final String ACTION_BAZ = "com.sito.evpro.inspection.service.action.BAZ";

    // TODO: Rename parameters
    private static final String EXTRA_PARAM1 = "com.sito.evpro.inspection.service.extra.PARAM1";
    private static final String EXTRA_PARAM2 = "com.sito.evpro.inspection.service.extra.PARAM2";
    ...
    public static void strarPlayVoice(Context context, String path) {
        Intent intent = new Intent(context, VoiceIntentService.class);
        intent.setAction(ACTION_FOO);
