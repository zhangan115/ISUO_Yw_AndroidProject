...
import com.isuo.yw2application.mode.inject.bean.UploadBean;
import com.isuo.yw2application.view.base.BaseActivity;
import com.isuo.yw2application.widget.InjectItemLayout;
...
public class InjectOilActivity extends BaseActivity implements InjectOilContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView name = findViewById(R.id.tvEquipmentName);
        name.setText(equipment.getEquipmentName());
        TextView sn = findViewById(R.id.tvEquipmentSn);
            ...
            case R.id.btnInject:
                ...
                try {
                    if (!jsonObject.has("nextTime")) {
                        Yw2Application.getInstance().showToast("请选择下次注油时间");
                        return;
                    }
                    ...
                    for (int i = 0; i < itemBean.getList().size(); i++) {
                        ...
                        if (TextUtils.isEmpty(value) && itemBean.getList().get(i).getIsRequeired() == 1) {
                            Yw2Application.getInstance().showToast("有漏检");
                            return;
                        }
    ...
    public void injectSuccess() {
        Yw2Application.getInstance().showToast("注油完成");
