...
public class UploadTaskInfo {
    ...
    public UploadTaskInfo(long endTime, int isManualCreated, long planEndTime, long planStartTime, long startTime, long taskId, String taskName, int taskState, List<UploadRoomListBean> roomList) {
