...
public class SpeechActivity extends BaseActivity {
    ...
    public void setParam() {
        ...
        if (TextUtils.isEmpty(voiceName)) {
            ...
            if (new File(CustomerApp.getInstance().getCacheDir() + File.separator + voiceName + ".wav").exists()) {
                new File(CustomerApp.getInstance().getCacheDir() + File.separator + voiceName + ".wav").delete();
            }
            mIat.setParameter(SpeechConstant.ASR_AUDIO_PATH, CustomerApp.getInstance().getCacheDir() + File.separator + voiceName + ".wav");
        }
