...
public class ForgePassActivity extends BaseActivity implements View.OnClickListener, ForgePassContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DaggerForgePassComponent.builder().customerRepositoryComponent(CustomerApp.getInstance().getRepositoryComponent())
    ...
    public void registerFail() {
        CustomerApp.getInstance().showToast("密码重置失败");
    }

    @Override
    public void registerSuccess() {
        CustomerApp.getInstance().showToast("密码重置成功");
