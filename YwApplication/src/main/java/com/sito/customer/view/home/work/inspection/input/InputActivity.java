...
import com.sito.customer.widget.Type1Layout;
import com.sito.customer.widget.Type2_4Layout;
import com.sito.customer.widget.Type3Layout;
...
public class InputActivity extends BaseActivity implements Type3Layout.OnTakePhotoListener, InputContract.View {
        ...
        switch (v.getId()) {
            ...
            case R.id.tv_finish_input:
                ...
                if (canFinish) {
                    ...
                    CustomerApp.getInstance().showToast("还有数据没有录入!");
                }
                break;
        }
    }
    ...
    public void onDeletePhoto(DataItemBean dataItemBean) {
        ...
        CustomerApp.getInstance().getDaoSession().getEquipmentDataDbDao().insertOrReplaceInTx(dataDb);
        refreshUi();
    }
            ...
            PhotoUtils.cropPhoto(this, photoFile, new PhotoUtils.PhotoListener() {
                ...
                public void onSuccess(File file) {
                    ...
                    if (mDataItemBean != null) {
                        ...
                        CustomerApp.getInstance().getDaoSession().getEquipmentDbDao()
    ...
    public void showCareData(FocusBean f) {
        ...
        TextView care_time = (TextView) findViewById(R.id.care_time);
        TextView care_des = (TextView) findViewById(R.id.care_des);
