...
public class ToolsDetailActivity extends BaseActivity implements ToolsDetailContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        llBorrow = (LinearLayout) findViewById(R.id.llBorrow);
    ...
    public void showTools(final Tools tools) {
        ...
        ImageView ivToolsPhoto = (ImageView) findViewById(R.id.ivToolsPhoto);
        ...
        TextView tvToolsState = (TextView) findViewById(R.id.tvToolsState);
        ...
        TextView tvToolsCustomerLocal = (TextView) findViewById(R.id.tvToolsCustomerLocal);
        TextView tvToolsBorrow = (TextView) findViewById(R.id.tvToolsBorrow);
        TextView tvToolsIn = (TextView) findViewById(R.id.tvToolsIn);
        TextView tvToolsReturn = (TextView) findViewById(R.id.tvToolsReturn);
        TextView tvToolsCustomerAsk = (TextView) findViewById(R.id.tvToolsCustomerAsk);

        TextView tvToolsUse = (TextView) findViewById(R.id.tvToolsUse);
        TextView tvToolsUseTime = (TextView) findViewById(R.id.tvToolsUseTime);
        TextView tvToolsReturnTime = (TextView) findViewById(R.id.tvToolsReturnTime);
        ...
        TextView tvToolsLocal = (TextView) findViewById(R.id.tvToolsLocal);
        if (isCustomer) {
        ...
        TextView tvToolsNum = (TextView) findViewById(R.id.tvToolsNum);
        tvToolsNum.setText(String.format("设备编号:%s", tools.getToolNumber()));
        TextView tvToolsDes = (TextView) findViewById(R.id.tvToolsDes);
        tvToolsDes.setText(tools.getToolDesc());
        TextView tvToolsBuyTime = (TextView) findViewById(R.id.tvToolsBuyTime);
        TextView tvToolsM = (TextView) findViewById(R.id.tvToolsM);
        TextView tvToolsCount = (TextView) findViewById(R.id.tvToolsCount);
        TextView tvToolsUnitPrice = (TextView) findViewById(R.id.tvToolsUnitPrice);
    ...
    public void askSuccess() {
        CustomerApp.getInstance().showToast("发送成功");
    }
