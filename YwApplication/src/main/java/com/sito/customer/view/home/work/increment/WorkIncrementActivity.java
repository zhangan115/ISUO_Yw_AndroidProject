...
import com.sito.customer.view.home.discover.generate.increment.GenerateIncrementActivity;
import com.sito.customer.view.home.work.increment.detail.IncrementDetailActivity;
import com.sito.customer.view.home.work.increment.execute.IncrementWorkActivity;
import com.sito.customer.view.home.work.increment.submit.IncrementActivity;
...
public class WorkIncrementActivity extends BaseActivity implements IncrementContract.View, SwipeRefreshLayout.OnRefreshListener
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new IncrementPresenter(CustomerApp.getInstance().getWorkRepositoryComponent().getRepository(), this);
        ...
        RVAdapter<IncrementBean> adapter = new RVAdapter<IncrementBean>(mRecyclerView, mList, R.layout.item_increment) {
            ...
            public void showData(ViewHolder vHolder, final IncrementBean data, final int position) {
                ...
                if (data.getWorkIssued() == 0) {
                    ...
                    if (data.getIssuedUser() != null && data.getIssuedUser().getUserId() == CustomerApp.getInstance().getCurrentUser().getUserId()) {
                ...
                tv_increment_name.setText(CustomerApp.getInstance().getMapOption().get("1").get(String.valueOf(data.getWorkType())));
