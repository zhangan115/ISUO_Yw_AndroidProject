...
import com.sito.customer.view.equip.time.detail.EquipmentRecordDetailActivity;
...
public class EquipmentTimeLineFragment extends MvpFragment<EquipmentTimeLineContract.Presenter> implements EquipmentTimeLineContract.View
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        new TimeLinePresenter(CustomerApp.getInstance().getEquipmentRepositoryComponent().getRepository(), this);
