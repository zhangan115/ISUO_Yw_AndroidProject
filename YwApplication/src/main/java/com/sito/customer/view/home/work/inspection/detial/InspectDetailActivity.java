...
import com.sito.customer.view.home.work.inspection.data.InspectionDataActivity;
...
public class InspectDetailActivity extends NotifyActivity implements InspectDetailContract.View
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DaggerInspectDetailComponent.builder().customerRepositoryComponent(CustomerApp.getInstance().getRepositoryComponent())
    ...
    private void initData() {
        ...
        RVAdapter<FaultList> adapter = new RVAdapter<FaultList>(mExpendRecycleView, mList, R.layout.item_fault_list) {
            ...
            public void showData(ViewHolder vHolder, final FaultList data, final int position) {
                ...
                mFaultState.setText(CustomerApp.getInstance().getMapOption().get("9").get(data.getFaultState() + ""));
    ...
    public void showCheckInfo(CheckBean bean) {
        ...
        if (!TextUtils.isEmpty(rooms)) {
            mInspectPlace.setText(rooms.substring(1, rooms.length()));
        }
        mInspectState.setText(CustomerApp.getInstance().getMapOption().get("5").get(bean.getTaskState() + ""));
        mInspectNum.setText(bean.getUploadCount() + "/" + bean.getCount() + "台");
        ...
        mInspectReport.setText(bean.getAllFault() + "个");
        mInspectDeal.setText(bean.getFlowingCount() + "个");
        mInspectCheck.setText(bean.getRepairCount() + "个");
        mInspectDo.setText(bean.getPendingCount() + "个");
        mInspectClose.setText(bean.getCloseCount() + "个");
