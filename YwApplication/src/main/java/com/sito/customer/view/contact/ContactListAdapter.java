...
class ContactListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (data.get(groupPosition).getUserList().get(childPosition).getUser().getUserId() == CustomerApp.getInstance().getCurrentUser().getUserId()) {
            GlideUtils.ShowCircleImage(context, CustomerApp.getInstance().getCurrentUser().getPortraitUrl()
