...
import com.sito.customer.view.home.work.IRepairDataChangeListener;
...
public class EquipmentAlarmFragment extends LazyLoadFragmentV4<EquipAlarmContract.Presenter> implements EquipAlarmContract.View
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        new EquipAlarmPresenter(CustomerApp.getInstance().getRepositoryComponent().getRepository(), this);
    }
