...
public class DatePickerDialog extends DialogFragment implements
    ...
    private HashSet<com.wdullaer.materialdatetimepicker.OnDateChangedListener> mListeners = new HashSet<>();
    ...
    @Override
    public void registerOnDateChangedListener(com.wdullaer.materialdatetimepicker.OnDateChangedListener listener) {
        mListeners.add(listener);
    }

    @Override
    public void unregisterOnDateChangedListener(com.wdullaer.materialdatetimepicker.OnDateChangedListener listener) {
        mListeners.remove(listener);
    }

    private void updatePickers() {
        for (com.wdullaer.materialdatetimepicker.OnDateChangedListener listener : mListeners) listener.onDateChanged();
    }
